...
{
    static readonly int _offsetSphereGrid = OffsetScanner.GetOffset(GameOffset.FFX_SphereGrid);
    static readonly int _offsetCurrentNode = _offsetSphereGrid + 0x1130C;

    static readonly int _sizeSphereGridNode = Marshal.SizeOf<SphereGridNode>();
    ...
    public static string[] GetNames() => NodeTypes.Select(n => n.Name).ToArray();
...
public struct SphereGridNode
{
    ...
    public long unknown_4;

    [MarshalAs(UnmanagedType.U8)]
    public long unknown_5;

    [MarshalAs(UnmanagedType.U8)]
    public long unknown_6;

    [MarshalAs(UnmanagedType.U1)]
    public byte unknown_7;

    [MarshalAs(UnmanagedType.U1)]
    public byte ActivatedBy;
