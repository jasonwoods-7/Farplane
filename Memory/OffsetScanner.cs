...
{
    static readonly SigScan _sigScan = new();

    static readonly OffsetBytePattern[] _bytePatterns =
    [
    ...
    static readonly Dictionary<GameOffset, int> _offsets = [];
    ...
    static bool FindOffset(GameOffset offsetType)
    {
